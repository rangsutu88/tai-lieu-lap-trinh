...
AS
	INSERT INTO student VALUES(@RollNo,@ClassCode, 
								@FullName,@Male,@Birthday,@Address,@Email)

exec ins_student 'B101','C0611L','CuongNC',1,'9/1/1990','Ha Noi','BVcuong@yahoo.com'
exec ins_student 'B102','C0611L','TuanPM',1,'9/1/1990','Ha Noi','TuanPM@yahoo.com'
...
--print 'Tong so sv:' + convert(varchar(10),@count)
print 'Tong so sv:' + cast(@count as varchar(10))
